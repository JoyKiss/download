 ...
 * 
 * **/
public class GetLearnList {

	public static void main(String[] args) throws Exception {

		GetLearnList jli = new GetLearnList();
		// jli.login("xxxxx", "xxxxx");// 输入Iteye的用户名，和密码
		jli.getUrl("http://www.imooc.com/user/newlogin");
	...
	public void login(String userName, String pwd) throws Exception {
		...
		// 第一次请求
		Connection con = Jsoup.connect("http://www.imooc.com/user/newlogin");// 获取连接
